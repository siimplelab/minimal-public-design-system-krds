...
import { z } from "zod";
import { FileText, Paperclip, ShieldCheck, UserRound } from "lucide-react";
import {
  FileAttachmentField,
  FormSection,
  PageHeader,
...
function FieldError({ message }: { message?: string }) {
  ...
  return <p className="mt-1.5 text-sm tracking-[-0.015em] text-[#c9302c]">{message}</p>;
}
      ...
      <div className="mt-6 space-y-4">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5" noValidate>
          <FormSection
            ...
            description="신청할 서비스와 연락 수단을 선택합니다."
          >
            <div>
              <label className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default" htmlFor="serviceType">
                서비스 유형
              </label>
              <Controller
            ...
            <div>
              <span className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default">연락 방식</span>
              <Controller
                control={form.control}
                name="contactChannel"
                render={({ field }) => (
                  <RadioGroup value={field.value} onValueChange={field.onChange}>
                    <label
                      htmlFor="channel-sms"
                      className="flex items-center gap-3 rounded-[0.625rem] border border-[rgba(0,0,0,0.10)] px-4 py-3 transition-colors hover:bg-bg-subtle has-[:checked]:border-[#0071e3] has-[:checked]:bg-[#e8f1ff]"
                    >
                      <RadioGroupItem id="channel-sms" value="sms" />
                      <span className="text-sm tracking-[-0.015em]">문자 안내</span>
                    </label>
                    <label
                    ...
                    >
                      ...
                      <span className="text-sm tracking-[-0.015em]">이메일 안내</span>
                    </label>
                    <label
                    ...
                    >
                      ...
                      <span className="text-sm tracking-[-0.015em]">유선 연락</span>
                    </label>
                  </RadioGroup>
                )}
              />
          ...
          <FormSection
            ...
            description="신청인 본인 확인 및 연락을 위한 정보입니다."
          >
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label htmlFor="applicantName" className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default">
                  성명
                </label>
              ...
              <div>
                <label htmlFor="residentNumber" className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default">
                  주민등록번호
                </label>
              ...
              <div>
                <label htmlFor="phone" className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default">
                  휴대전화
                </label>
              ...
              <div>
                <label htmlFor="address" className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default">
                  주소
                </label>
            ...
            <div>
              <label htmlFor="requestDetail" className="mb-2 block text-sm font-medium tracking-[-0.015em] text-fg-default">
                요청 내용
              </label>
              <Textarea
                id="requestDetail"
          ...
          <FormSection
            ...
            description="증빙자료를 첨부하고 동의 여부를 확인합니다."
          >
            <FileAttachmentField />
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <div>
                <label htmlFor="agreePolicy" className="text-sm font-medium tracking-[-0.015em] text-fg-default">
                  <span className="inline-flex items-center gap-1.5">
                    <ShieldCheck className="h-3.5 w-3.5 text-fg-muted" aria-hidden="true" />
                    개인정보 수집 및 이용에 동의합니다.
                  </span>
                </label>
                <p className="mt-1.5 text-sm tracking-[-0.015em] text-fg-muted">신청 처리 및 결과 안내를 위해 필요한 범위 내에서만 이용됩니다.</p>
